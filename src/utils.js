...
export const NAV_ICON_KEYS = ['dashboard','search','settings','movies','tvshows','tv','folder','star','heart','book','globe','music','photo','sparkles','bolt','ticket'];
...
export const AVATAR_ICON_KEYS = ['person', 'users', 'academicCap', 'trophy', 'smiley', 'heart', 'star', 'rocket', 'puzzle', 'bolt', 'sparkles'];
