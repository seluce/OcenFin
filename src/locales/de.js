...
export default {
    ...
    themeMusic: "Theme-Musik",
    themeMusicDesc: "Spielt die Titelmusik auf der Detailseite ab (erfordert Theme-Songs in der Bibliothek).",
    themeMusicVolume: "Lautstärke",
    themeMusicBoth: "Beides",
    ...
    settingsRemote: "Fernbedienung",
    remoteDigitSeek: "Zifferntasten-Sprung",
    remoteDigitSeekDesc: "Zifferntasten springen während der Wiedergabe zu 0–90 % der Laufzeit (5 = Mitte).",
    remoteChannelZap: "Kanaltasten-Zapping",
    remoteChannelZapDesc: "Kanal hoch/runter wechselt zur nächsten bzw. vorherigen Folge.",
    remoteColorButtons: "Farbtasten",
    remoteColorButtonsDesc: "Nur während der Wiedergabe aktiv. Außerhalb tun die Farbtasten nichts.",
    remoteColorRed: "Rot",
    remoteColorGreen: "Grün",
    remoteColorYellow: "Gelb",
    remoteColorBlue: "Blau",
    remoteButtonAction: "Tastenbelegung",
    remoteActionOff: "Keine Aktion",
    remoteActionSubtitleToggle: "Untertitel ein/aus",
    remoteActionSubtitleMenu: "Untertitel-Menü",
    remoteActionAudioMenu: "Audio-Menü",
    remoteActionPlayPause: "Wiedergabe/Pause",
    ...
    sharedQuickConnect: "Auf dem anderen Handy bestätigen",
    sharedInvalidChoice: "Dieses Profil geht hier nicht — es ist dein eigenes oder bereits gewählt.",
