...
export default {
    ...
    themeMusicDesc: "Play a title’s theme song on its details page (requires theme songs in the library).",
    ...
    remoteDigitSeek: "Number key jump",
    remoteDigitSeekDesc: "Number keys jump to 0–90% of the runtime during playback (5 = middle).",
    remoteChannelZap: "Channel key zapping",
    remoteChannelZapDesc: "Channel up/down switches to the next or previous episode.",
    remoteColorButtons: "Color buttons",
    remoteColorButtonsDesc: "Only active during playback. Elsewhere the color buttons do nothing.",
    remoteColorRed: "Red",
    remoteColorGreen: "Green",
    remoteColorYellow: "Yellow",
    remoteColorBlue: "Blue",
    remoteButtonAction: "Button action",
    remoteActionOff: "No action",
    remoteActionSubtitleToggle: "Subtitles on/off",
    remoteActionSubtitleMenu: "Subtitle menu",
    remoteActionAudioMenu: "Audio menu",
    remoteActionPlayPause: "Play/Pause",
    subtitleLanguage: "Default Subtitles",
    rememberSubtitleTrack: "Remember subtitle per series",
    rememberSubtitleTrackDesc: "Automatically applies the chosen subtitle to the next episodes of a series.",
    ...
    displayDashboardBackdrop: "Backdrop Preview (Dashboard)",
    ...
    uiFont: "Font",
    uiFontDesc: "Changes the font used across the entire app (not for styled ASS subtitles).",
    fontSystem: "Default",
    chapter: "Chapter",
    ...
    sharedQuickConnect: "Confirm on the other phone",
    sharedInvalidChoice: "That profile cannot be used here — it is your own or already chosen.",
    ...
    subtitleFont: "Font",
    subtitleFontDesc: "Applies to text subtitles (VTT/SRT) only — independent of the UI font. ASS uses its own fonts.",
    colorWhite: "White",
    colorYellow: "Yellow",
    colorGreen: "Green",
    colorCyan: "Cyan",
